...
import CommentableItems from '../../Components/CommentableItems';
...
const Comment = () => {
    ...
    const fetchComments=async()=>{
      try{
          ...
          console.log("✅ COMMENTS:", data.comments); // Move here
...
console.log("comments state:", comments);
  ...
  <table className="w-full text-sm text-gray-500">
    ...
    <tbody>
      ...
      }).map((comment,index)=><CommentableItems key={comment._id} 
